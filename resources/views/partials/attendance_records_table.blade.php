            ...
            <tbody class="list-table-body">
                @foreach ($attendanceRecords as $attendance)
                    ...
                    <tr class="list-table-row">
                        ...
                        <td class="list-table-cell">{{ $attendance->check_in_at ? \Carbon\Carbon::parse($attendance->check_in_at)->format('H:i') : '' }}</td>
                        <td class="list-table-cell">{{ $attendance->check_out_at ? \Carbon\Carbon::parse($attendance->check_out_at)->format('H:i') : '' }}</td>
                        <td class="list-table-cell">{{ $attendance->check_in_at ? App\Services\DurationService::formatSeconds($breakSeconds) : '' }}</td>
                        <td class="list-table-cell">{{ ($attendance->check_in_at && $attendance->check_out_at) ? App\Services\DurationService::formatSeconds($totalSeconds) : '' }}</td>
