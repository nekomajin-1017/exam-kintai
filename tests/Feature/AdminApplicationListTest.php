...
class AdminApplicationListTest extends TestCase
{
    ...
    public function showsPendingRequestsForAdmin(): void
    {
    ...
    public function showsApprovedRequestsForAdmin(): void
    {
        $admin = User::factory()->create(['is_admin' => true]);
        $userA = User::factory()->create(['is_admin' => false, 'name' => '申請者A']);
        $userB = User::factory()->create(['is_admin' => false, 'name' => '申請者B']);
    ...
    public function showsRequestDetailForAdmin(): void
    {
        $admin = User::factory()->create(['is_admin' => true]);
    ...
    public function approvesRequestAndUpdatesAttendance(): void
    {
        $admin = User::factory()->create(['is_admin' => true]);
